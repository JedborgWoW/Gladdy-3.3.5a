...
local specColors = {
    ["DEATHKNIGHT"] = {
        [L["Blood"]] = { r = 0.796, g = 0.333, b = 0.333, hex = "cb5555", color = {r=0.796, g=0.333, b=0.333, a=1} },
        [L["Frost"]] = { r = 0.580, g = 0.580, b = 0.737, hex = "9494bc", color = {r=0.580, g=0.580, b=0.737, a=1} },
        [L["Unholy"]] = { r = 0.565, g = 0.796, b = 0.333, hex = "90cb55", color = {r=0.565, g=0.796, b=0.333, a=1} },
    },
    ["DRUID"] = {
        [L["Balance"]] = { r = 0.322, g = 0.322, b = 0.620, hex = "52529e", color = {r=0.322, g=0.322, b=0.620, a=1} },
        [L["Feral"]] = { r = 0.000, g = 0.376, b = 0.565, hex = "006090", color = {r=0.000, g=0.376, b=0.565, a=1} },
        [L["Guardian"]] = { r = 0.075, g = 0.376, b = 0.678, hex = "1360ad", color = {r=0.075, g=0.376, b=0.678, a=1} },
        [L["Restoration"]] = { r = 0.655, g = 0.851, b = 0.753, hex = "a7d9c0", color = {r=0.655, g=0.851, b=0.753, a=1} },
    },
    ["HUNTER"] = {
        [L["Beast Mastery"]] = { r = 0.620, g = 0.620, b = 0.322, hex = "9e9e52", color = {r=0.620, g=0.620, b=0.322, a=1} },
        [L["Marksmanship"]] = { r = 0.851, g = 0.753, b = 0.655, hex = "d9c0a7", color = {r=0.851, g=0.753, b=0.655, a=1} },
        [L["Survival"]] = { r = 0.376, g = 0.678, b = 0.075, hex = "60ad13", color = {r=0.376, g=0.678, b=0.075, a=1} },
    },
    ["MAGE"] = {
        [L["Arcane"]] = { r = 0.129, g = 0.565, b = 1.000, hex = "2190ff", color = {r=0.129, g=0.565, b=1.000, a=1} },
    ...
    ["PALADIN"] = {
        ...
        [L["Retribution"]] = { r = 0.737, g = 0.580, b = 0.737, hex = "bc94bc", color = {r=0.737, g=0.580, b=0.737, a=1} },
    },
    ["PRIEST"] = {
        [L["Discipline"]] = { r = 1.000, g = 1.000, b = 1.000, hex = "ffffff", color = {r=1.000, g=1.000, b=1.000, a=1} },
        [L["Holy"]] = { r = 0.655, g = 0.753, b = 0.851, hex = "a7c0d9", color = {r=0.655, g=0.753, b=0.851, a=1} },
        [L["Shadow"]] = { r = 1.000, g = 0.565, b = 0.129, hex = "ff9021", color = {r=1.000, g=0.565, b=0.129, a=1} },
    },
    ["ROGUE"] = {
        [L["Assassination"]] = { r = 0.796, g = 0.333, b = 0.333, hex = "cb5555", color = {r=0.796, g=0.333, b=0.333, a=1} },
        [L["Combat"]] = { r = 0.678, g = 0.376, b = 0.075, hex = "ad6013", color = {r=0.678, g=0.376, b=0.075, a=1} },
        [L["Subtlety"]] = { r = 0.376, g = 0.376, b = 0.376, hex = "606060", color = {r=0.376, g=0.376, b=0.376, a=1} },
    },
    ["SHAMAN"] = {
        [L["Elemental"]] = { r = 0.168, g = 0.251, b = 1, hex = "2b40ff", color = {r=0.168, g=0.250, b=1, a=1} },
        [L["Enhancement"]] = { r = 0.737, g = 0.580, b = 0.580, hex = "bc9494", color = {r=0.737, g=0.580, b=0.580, a=1} },
        [L["Restoration"]] = { r = 0.322, g = 0.620, b = 0.322, hex = "529e52", color = {r=0.322, g=0.620, b=0.322, a=1} },
    },
    ["WARLOCK"] = {
        [L["Affliction"]] = { r = 0.376, g = 0.678, b = 0.075, hex = "60ad13", color = {r=0.376, g=0.678, b=0.075, a=1} },
        [L["Demonology"]] = { r = 0.431, g = 0.133, b = 0.431, hex = "6e226e", color = {r=0.431, g=0.133, b=0.431, a=1} },
        [L["Destruction"]] = { r = 0.922, g = 0.322, b = 0.020, hex = "eb5205", color = {r=0.922, g=0.322, b=0.020, a=1} },
    },
    ["WARRIOR"] = {
        [L["Arms"]] = { r = 0.580, g = 0.580, b = 0.737, hex = "9494bc", color = {r=0.580, g=0.580, b=0.737, a=1} },
        [L["Fury"]] = { r = 0.753, g = 0.376, b = 0.000, hex = "c06000", color = {r=0.753, g=0.376, b=0.000, a=1} },
        [L["Protection"]] = { r = 0.565, g = 0.565, b = 0.565, hex = "909090", color = {r=0.565, g=0.565, b=0.565, a=1} },
    },
}
