...
function Trinket:CreateFrame(unit)
    local trinket = CreateFrame("Button", "GladdyTrinketButton" .. unit, Gladdy.buttons[unit], nil)
...
-- ARENA_COOLDOWNS_UPDATE removed: C_PvP.GetArenaCrowdControlInfo does not exist in 3.3.5a
-- Trinket tracking relies on combat log events (UNIT_SPELLCAST_SUCCEEDED) handled in EventListener.lua
