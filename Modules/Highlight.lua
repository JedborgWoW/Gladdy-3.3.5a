...
function Highlight:CreateFrame(unit)
    ...
    local targetBorder = CreateFrame("Frame", nil, button, nil)
    ...
    local focusBorder = CreateFrame("Frame", nil, button, nil)
    ...
    local leaderBorder = CreateFrame("Frame", nil, button, nil)
    ...
    leaderBorder:EnableMouse(false)
    leaderBorder:Hide()
