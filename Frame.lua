...
function Gladdy:CreateFrame()
    ...
    self.frame.background = CreateFrame("Frame", nil, self.frame, nil)
    ...
    self.anchor = CreateFrame("Button", "GladdyAnchor", self.frame, nil)
...
function Gladdy:CreateButton(i)
    ...
    local testModeBorder = CreateFrame("Frame", nil, button, nil)
...
function Gladdy:CreateMover(frame, xConfig, yConfig, name, points, width, height, xOffset, yOffset, activated)
    if not frame.mover then
        ...
        frame.mover = CreateFrame("Frame", nil, frame, nil)
        ...
        frame.mover.border = CreateFrame("Frame", nil, frame.mover, nil)
